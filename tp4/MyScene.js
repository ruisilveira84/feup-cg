...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.texture4 = new CGFtexture(this, 'images/mineTop.png');
        ...
        this.cube = new MyUnitCubeQuad(this, this.texture4, this.texture5, this.texture6); 
    ...
    toggleTangram() {
        this.displayTangram = !this.displayTangram;
    }
